		...
		<div class="main-content">
			...
			<div class="row">
				...
				<div class="span8 left-dash-border">
					<div class="row margin-top-20 margin-left-20">
						<div class="span3">
							<a href="#"><img src="http://placekitten.com/220/200" /></a>
						</div>
						<div class="span4">
							<h3>子項目標題</h3>
							<a href="#"><p>Nullam quligula, eget lacinia odio sem nec elit.……（繼續閱讀）</p></a>
						</div>
					</div>
					<hr class="dashed-hr margin-bottom-none"></hr>
					<div class="row margin-top-20 margin-left-20">
