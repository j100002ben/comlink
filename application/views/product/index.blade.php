			...
			<div class="row">
				...
				<div class="span8 left-dash-border">
					<div class="margin-top-20 margin-left-20">
						<div class="row">
							<div class="span8"><img src="http://placekitten.com/620/400" /></div>
						</div>
					</div>
					<div class="margin-top-20 margin-bottom-20 margin-left-20 row">
						<table class="table-separate"><tbody>
							<tr>
								<td><img src="http://placekitten.com/120/100" /></td>
								<td><img src="http://placekitten.com/120/100" /></td>
								<td><img src="http://placekitten.com/120/100" /></td>
								<td><img src="http://placekitten.com/120/100" /></td>
								<td><img src="http://placekitten.com/120/100" /></td>
					...
					<div class="margin-left-20">
						<h4>產品介紹</h4>
						<p>讓緊手安義充觀進利風新爸路黃過，斯老太黑命面金運話，山破了際、廣調樣說至力又以叫有市位的線。都十所合日員求，山科留三飛主格飯呢、樹同告道才媽們此看統車電</p>
					</div>
				</div>
			</div>
		</div>
