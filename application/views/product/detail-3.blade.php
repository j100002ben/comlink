...
<?php
$pchome_link = 'http://www.pcstore.com.tw/comlinktek/M13814301.htm';
$pinkoi_link = 'http://www.pinkoi.com/product/1yAT83nG';
...
<div class="main-content">
	<hr class="dashed-hr"></hr>
		<div class="row">
			...
			<div class="span6">
				<img id="image-container" src="{{ asset('img/product/'.$link_name.'-04.jpg') }}" />
			</div>
			<div class="span4">
				<h3>杯墊</h3>
				<ul class="unstyled">
					<li>材質 / 陶瓷</li>
					<li>尺寸 / 11 × 11 ×0.7 （cm）</li>
				</ul>
				<div class="clearfix">
