...
<?php
$pchome_link = 'http://www.pcstore.com.tw/comlinktek/M13830919.htm';
$pinkoi_link = 'http://www.pinkoi.com/product/1hEph2Nj';
		...
		<div class="row" id="product-spot">
			<div class="span2">
				<ul class="unstyled">
					...
					<li class="margin-bottom-10"><img src="{{ asset('img/product/'.$link_name.'-05.jpg') }}" /></li>
