<div>
	<ul class="breadcrumb">
		...
		<li>
			<a href="<?php echo route('admin.page');?>">頁面管理</a> <span class="divider">/</span>
		</li>
		<li>
			<a href="<?php echo route('admin.page.edit', array($page->id));?>">編輯頁面</a>
		</li>
	</ul>
</div>
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>編輯頁面 - {{ $page->title }}</h2>
			<div class="box-icon">
				<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
			</div>
		</div>
		<div class="box-content">
			<?php echo Form::open(route('admin.page.edit', array($page->id)), 'POST', array('class' => 'form-horizontal')); ?>
			  <fieldset>
				<legend>頁面資訊</legend>
				<div class="control-group {{ $errors->has('title') ? 'error' : '' }}">
				  <label class="control-label" for="title">頁面標題</label>
				  <div class="controls">
				  	<?php echo Form::text( 'title', Input::old( 'title', $page->title ),
				...
				<div class="control-group {{ $errors->has('menu_order') ? 'error' : '' }}">
				  ...
				  <div class="controls">
				  	<?php echo Form::text( 'menu_order', Input::old( 'menu_order', $page->menu_order ),
				...
				<div class="control-group {{ $errors->has('content') ? 'error' : '' }}">
				  ...
				  <div class="controls">
				  	<?php echo Form::textarea( 'content', Input::old( 'content', $page->content ),
				...
				<div class="form-actions">
				  <button type="submit" class="btn btn-primary">修改頁面</button>
