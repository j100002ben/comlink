<div>
	<ul class="breadcrumb">
		...
		<li>
			<a href="<?php echo route('admin.news');?>">最新消息</a>
		</li>
	</ul>
</div>
...
<div class="row-fluid">
	<div class="box span12">
		...
		<div class="box-content">
			<p class="left">
				<a href="<?php echo route('admin.news.new');?>" class="btn btn-large btn-primary">新增頁面</a> 
			</p>
	...
	<div class="box span12">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <tbody>
				<?php echo render_each('charisma::pages.news-list', $pages, 'page'); ?>
			  </tbody>
		  </table>    
		  <script>
